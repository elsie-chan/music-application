<div class="formbold-main-wrapper">
    <div class="formbold-form-wrapper">
        <form action="<?php echo url('admin/artist/edit_artist') ?>" method="POST">
            <input type="hidden" name="id_artist" value="<?php echo $data['artist']->id_artists?>">
            <div class="formbold-input-flex">
                <div>
                    <input
                        ...
                        name="name_artist"
                        id="name_artist"
                        value="<?php echo $data['artist']->name_artists?>"
                        class="formbold-form-input"
                    />
                    <label for="firstname" class="formbold-form-label">Artist Name</label>
                </div>
                <div>
                    <input
                        type="datetime-local"
                        name="birth_artist"
                        id="birthday_artist"
                        value="<?php echo date('Y-m-d\TH:i:s', strtotime($data['artist']->birthday))?>"
                        class="formbold-form-input"
                    />
                    <label for="birthday_artist" class="formbold-form-label"> Birthday Artist</label>
                </div>
            </div>
            ...
            <div class="formbold-input-flex">
                <div>
                    <input
                        ...
                        name="media_artist"
                        id="media_artist"
                        value="<?php echo $data['artist']->social_media?>"
                        class="formbold-form-input"
                    />
                    <label for="media_artist" class="formbold-form-label"> Media Artist </label>
                </div>
            </div>

            <div class="formbold-input-file">
                <div class="formbold-filename-wrapper files">
                    <span class="formbold-filename">
                        <?php echo url($data['artist']->picture);?>
                ...
                <label for="img_artist" class="formbold-input-label">
                    ...
                    Attach files
                    <input type="file" name="picture_artist" id="img_artist">
                </label>
            </div>
