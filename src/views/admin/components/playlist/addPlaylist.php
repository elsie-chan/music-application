        ...
        <form action="<?php echo url('admin/user/add_user') ?>" method="POST">
            <div class="formbold-input-flex">
                <div>
                    ...
                    />
                    <label for="id_user" class="formbold-form-label">ID user</label>
                </div>
                <div>
                    <input
                        type="text"
                        ...
                        class="formbold-form-input"
                    />
                    <label for="name_playlist" class="formbold-form-label">Playlist name</label>
                </div>
            </div>
            ...
            <div class="formbold-input-flex">
                <div class="formbold-input-file">
                    ...
                    <label for="img_album" class="formbold-input-label">
                        ...
                        Upload image of playlist
                        <input type="file" name="img_album" id="img_album">
                    </label>
                </div>
                <div>
                    <input
